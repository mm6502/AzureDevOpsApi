...
```
Export-DetermineOutputFileName [-ExportData] <Object> [-Path <Object>] [-FileExtension <Object>]
 [-UseConstantFileName] [-TimeZone <Object>] [-ProgressAction <ActionPreference>] [<CommonParameters>]
```
